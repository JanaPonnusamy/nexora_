/* ============================================================================
   ...
   ADAPTATIONS forced by the synced schema (legacy logic otherwise preserved):
     ...
     * sp_nmstock_get_purchases dropped `Sync = 0` (column not synced) and never
       returned a supplier (PurchaseTrans has none) — kept faithful.
...
/* ===========================================================================
   ...
   Faithful to sp_nmstock_get_purchases (no supplier column in the source).
   OUTPUT: grn_no, date, qty, free, dis, ptr, mrp
   =========================================================================== */
