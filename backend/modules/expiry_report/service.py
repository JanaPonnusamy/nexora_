...
_FN = {
    "store-summary": lambda t, s, sup, ack: repo.store_summary(t),
    "supplier-summary": lambda t, s, sup, ack: repo.supplier_summary(t, s),
    "supplier-pending": lambda t, s, sup, ack: repo.supplier_pending(t, s, sup),
    "supplier-acks": lambda t, s, sup, ack: repo.supplier_acks(t, s, sup),
    "ack-products": lambda t, s, sup, ack: repo.ack_products(t, s, ack),
}
...
def run(level, tenant_id, store_id=None, supplier_code=None, ack_number=None):
    ...
    _, rows = _FN[level](tenant_id, store_id, supplier_code, ack_number)
    return {
        "level": level,
