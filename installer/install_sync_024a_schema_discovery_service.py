...
print("=" * 50)
print("SYNC-024A INSTALLER")
print("Schema Discovery Service")
print("=" * 50)

project_root = Path(__file__).resolve().parent.parent

service_dir = project_root / "store_agent" / "services"
service_dir.mkdir(parents=True, exist_ok=True)

(service_dir / "__init__.py").touch(exist_ok=True)

service_file = service_dir / "schema_discovery_service.py"
...
print()
print(f"[OK] Created: {service_file}")
print()
print("SYNC-024A INSTALL COMPLETE")